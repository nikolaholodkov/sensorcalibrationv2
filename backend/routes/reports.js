  ...
  try {
    ...
    const reportResult = await client.query(
      `INSERT INTO calibration_reports (
        ...
        page3_test_date, page3_ambient_temp, page3_ambient_temp_uncertainty, 
        page3_relative_humidity, page3_relative_humidity_uncertainty,
        page3_atmospheric_pressure, page3_atmospheric_pressure_uncertainty,
      ...
      [
        ...
        page3_ambient_temp_uncertainty || null,
        page3_relative_humidity || null, 
        page3_relative_humidity_uncertainty || null,
        page3_atmospheric_pressure || null,
        page3_atmospheric_pressure_uncertainty || null,
        page3_as_received_g, 
        page3_as_received_h, 
        page3_as_received_i, 
        page3_as_received_j,
  ...
  try {
    ...
    const reportResult = await client.query(
      `UPDATE calibration_reports SET
        ...
        page3_test_date = $11, page3_ambient_temp = $12, page3_ambient_temp_uncertainty = $13,
        page3_relative_humidity = $14, page3_relative_humidity_uncertainty = $15,
        page3_atmospheric_pressure = $16, page3_atmospheric_pressure_uncertainty = $17,
